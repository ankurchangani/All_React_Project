...
import Finances from "../../assets/images/Porjects/Finances.png"
...
const projects = [
  ...
  },
  {
    ...
    title: "Music School",
    description:
      "Developed a responsive Music School website using Next.js and Tailwind CSS, featuring aceternity ui components.",
  ...
  }, 
  {
    ...
    title: "Finances",
    description:
      "Developed a responsive finance website using Next.js and Tailwind CSS, integrated with Supabase for database management and Gemini AI for intelligent features" ,
    github: "https://github.com/ankurchangani/Ai-Finance-platform.git",
    demo: "https://ai-finance-platform-zeta.vercel.app/",
  } ,
  {
    image: BhagavadGita,
    title: "Bhagavad Gita",
    ...
    <section className="py-20" id="projects">
      <div className="container mx-auto">
          ...
          {projects
            ...
            .map((project, index) => (
              <SwiperSlide key={index}>
                <motion.div
                  className="bg-gradient-to-br from-[#443C68] to-gray-800 shadow-2xl rounded-3xl overflow-hidden transition-all duration-500 hover:scale-105 border border-gray-700 p-6 w-full h-full"
        ...
        <div className="flex justify-center mt-10 mb-6">
          <motion.h3
            className="text-white text-xl font-bold sm:text-center w-full text-left sm:text-center"
              ...
              <div key={index} className="w-full">
                <div className="flex lg:flex-nowrap flex-wrap gap-6">
                  {[0, 1].map((i) => (
                    <motion.div
                      key={i}
                      className="w-full sm:w-1/2 lg:w-1/2 bg-gradient-to-br from-[#443C68] to-gray-800 shadow-2xl rounded-3xl overflow-hidden p-6"
                      variants={cardVariants}
                      initial="hidden"
                      whileInView="visible"
                      whileHover={{ scale: 1.05, rotateX: 3, rotateY: 3 }}
